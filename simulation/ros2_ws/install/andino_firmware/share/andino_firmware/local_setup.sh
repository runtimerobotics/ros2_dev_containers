...
: ${AMENT_CURRENT_PREFIX:="/workspaces/ros2_dev_containers/simulation/ros2_ws/install/andino_firmware"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/andino_firmware/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/andino_firmware/environment/path.sh"
